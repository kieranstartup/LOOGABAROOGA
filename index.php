...
jQuery('#static-image-8').attr('src','images/8.Sole_Flake_Centered.jpg');
        ...
        <div id="text-container">
            ...
            <div id="chapter-2">
                The phrase ‘corporate identity’ was ‘coined in the 1950s to describe how all of an organisation’s visible manifestations are designed to create a coherent whole associated with a specific theme, attitude, or personality’.<sup>1</sup> ‘Identity’ in this context is metaphor that allows us to deal with companies as if they were people with individual characteristics, memory and a soul. When the language of these corporations is applied to a place an uneasy clash happens. The language of the world of profit and sales starts to define a place and a group of people. This raises questions of why a place needs to be sold – who is selling it, and who is it being sold to? A brand defines what something is – selecting and distilling chosen characteristics into graphic form. As a result of this, a brand also defines what the same thing is not. So if a brand is colourful – then it excludes a preference for monochrome, if it is playful – then it excludes the serious, and so on. ‘…simplification denies the complexity of life’s experience, for while simple statements, familiar and repeated imagery sell the product and the idea most efficiently, they also reinforce restricting separations.’<sup>2</sup> Contradictions are characteristics of a mixed society. Could a graphic identity be designed which is suitably diverse, and could it still be ‘coherent’ or is incoherence precisely the point?
                <br>
                ...
                <br>
                <br> ‘I like my town, but I can’t say exactly what I like about it. I don’t think it’s the smell. I’m too accustomed to the monuments to want to look at them. I like certain lights, a few bridges, café terraces. I love passing through a place I haven’t seen for a long time.’<sup>3</sup>
            </div>
            <!-- ////////////////////////////////////////////////////// -->
            <!-- /////////////////// Chapter Three //////////////////// -->
            <!-- ////////////////////////////////////////////////////// -->
            ...
            <div id="chapter-3">
                ...
                <br>
                <br> Most places have established stories that are told about them. In the case of Loughborough, the presence of a company like Brush who build and export turbines globally becomes a characteristic of the town. The monumental <span id="reference-image-falcon-works" class="underline" >Falcon Works</span> overlooks the train station and the Brush social club extends the influence of the company further into the social fabric of the town. But there are pricklier stories too. Loughborough’s <span id="reference-image-immigration" class="underline" >Immigration Enforcement Reporting Centre</span> registers immigrants based in the three surrounding cities of Nottingham, Derby and Leicester. What place is there which could be more relevant to a discussion on identity than the centre which grants a British identity to a lucky few of those who visit it. Two very different organisations both playing hugely significant roles in the town, but it’s the Falcon works which provides the material suitable for the Loughborough’s <span id="reference-image-postcard" class="underline" >postcard</span> – a typical method by which an image of a place gets projected to the outside world. But internally stories are more readily told through informal methods such as chat, gossip, argument or joke. These have an immediacy which is powerful to the few who hear them. You can bet the conversations in the local pub are more often about the Immigration Enforcement Reporting Centre than they are about the Falcon Works. These everyday conversations might create a more powerful impression then what is on the postcard, but how quickly does that impression fade with time.
                <br>
                <br>Not every story can be told and many won’t feel relevant to a given project. But as a working methodology we are interested in excavating these artefacts and exploring some new mythologies out of fragments of the past and present. Objects are often able to articulate things that humans cannot. In the words of the designer Norman Potter ‘…every human artefact – whether painting, poem, chair, or rubbish bin – evokes and invokes the inescapable totality of a culture, and the hidden assumptions which condition cultural priorities’<sup>5</sup>. A philosophy of design and production, of place and time, is embodied in each and every object. By looking at the materials and forms at hand in a place, the byproducts of human endeavours, we get a sense of the layers of history that have laid the foundations of a place. These materials, and the stories that come with them, can then form the basis of a graphic response to a place.
            </div>
            <!-- ////////////////////////////////////////////////////// -->
            <!-- /////////////////// Chapter Four ///////////////////// -->
            <!-- ////////////////////////////////////////////////////// -->
            ...
            <div id="chapter-4">
                ...
                <br>
                <br> In Belco, Northern Ireland, the local authorities felt that it was necessary to bring new life to the high street ahead of the 39th G8 summit where it would be on show to world leaders and press. In a number of shops the authorities installed printed vinyl in the windows which showed busy vibrant shops. The shop shown here was once a butcher’s shop but had gone out of business. In this moment two versions of Belco exist at the same time – the image of the place and the real place. Ironically the official theme of the 2013 summit was transparency.
                <br>
                <br> Whilst we really enjoy this brilliantly executed illustration of how all places are a combination of a physical place alongside a projected image of a place, we suspect it wasn’t intended in this spirit. Instead it shows a more sombre longing for another time, an idealised image of a time when the high streets role within society served a different level of importance. By pretending that time and change hasn’t happened it feels like history is being denied. Pretending that nothing has changed since the 50s is not celebrating history, instead it denies the layers of change and complexity that make something old.
                <br>
                <br>‘Attempts at returning buildings to their original condition … robs them of the very quality for which they are prized; oldness, leaving behind shells that show no sign or wear and tear and are innocent of history.’<sup>8</sup>
                <br>
                <br>But then again perhaps this ‘original condition’ never existed in the first place, and the longing that is felt, particularly in the Belco case, is simply concealing this truth. ‘Nostalgia like any form of narrative, is always ideological: the past it seeks has never existed except as narrative, and hence, always absent.’<sup>9</sup> By looking for and highlighting unique layers of local history, one could be hiding the fact that under corporate capitalism every place is in fact the same. There is nothing unique, just Costa Coffee. Uniqueness is exactly what the mercantile competition craves, nothing more.
            </div>
            <!-- ////////////////////////////////////////////////////// -->
            <!-- /////////////////// Chapter Five ///////////////////// -->
            <!-- ////////////////////////////////////////////////////// -->
            ...
            <div id="chapter-5">
                Where there is a need for visual communication there is a need for a graphic language. We are much more comfortable with the term ‘language’ than we are with ‘identity’. A language implies something which is pliable and can be shaped by its users. Identity implies something more rigid, a finished item to be respected and adhered to.
                <br>
            ...
            <div id="chapter-6">
                ...
                <br>
                <br>Our approach to working in Loughborough has been through a method of triangulation – gaining a variety of viewpoints which allow us to gain a sense of the place – and doing this through a series of organised and also random encounters with local people, for example, meeting two Loughborough Town of Sanctuary volunteers outside the East Midlands Immigration Enforcement Centre. They provide a welcome, some practical information and the offer of a free hot drink to asylum seekers tasked with travelling weekly to sign in. This led us to John Storer House who provide those free hot drinks and further conversation in a vibrant community space. There a one-day-a-week volunteer spoke with relish of the varied requests that come her way. The port-of-call reception desk, offering cheap locally grown courgettes, epitomised this span of exchange, a narrative of civic actions and activism in a climate of cuts.
                <br>
                <br>A tatting-shuttle in the Charnwood Museum told of nineteenth century lacemakers supplementing their factory work with this complex hand technique. This interaction of hand and tool brings us to the Sports Technology Institute’s Steve Carr and his test run of a bonelike, low-melting-point, plastic tennis racket grip, designed for a para-athlete who had lost their ability to grip the racket. Steve is head of technical services and runs the test lab which holds a cross-section of kit from ball kicking robots and motion capture rigs to lathes, drills and welders. This oscillation from hardware-to-software-to-hardware mirrors Steve’s agility in tackling each research project whether it be the aerodynamic testing of Adidas’ next World Cup football, or the design and fabrication of a bespoke archery frame for Paralympian Danielle Brown. Whilst explaining the structural composition of dismembered match balls, Steve referred to the two interlocking panel types as ‘turbines and rotors’ recalling our visit to Brush and their turbogenerator manufacturing.
                <br>
                <br>Through a day of what we could call ‘identity consulting’ we asked passers by to share their stories of Loughborough with us. We set up in a vacant shop in the Carillon shopping centre. Visitors were asked to create object compositions with produce from the market and other pre-prepared objects. 
                <br>
                <br>
What can we bring to the place through working here? We began as outsiders, looking at the town with the fresh eyes of a tourist. This provides us with both advantages and weaknesses over those who are familiar with the place. Foreign eyes notice things that familiar ones overlook, but at the same time they lack knowledge. Through a process of discovery, time spent in the place and encounters with locals we begin an act of learning and processing before being able to convey something back visually.
                <br>
                <br>
                A place can never be viewed as a whole. Taking a reading of a place is a useful way by which we can provoke a conversation about a place. We have worked with a range of objects that reference stories that we have encountered in the city. The work we have created is not presented as the new identity for Loughborough, it does not claim to define the place, but it is a response to Loughborough that explores its identity in an open ended way. Through a juxtaposition of objects we encourage viewers to reflect on Loughborough and provoke further thought about the place. We explore no more than a few of the infinite number of stories that make up the town. Our selection of objects and our stylistic preferences are deliberate and subjective, but this shows the very essence of personal involvement that is lacking in the bland, un-nuanced branding that has come to define many towns and cities.
            </div>
            <div class="endnote-text">
                ...
                <br> <span class="number-spacing">3</span> Georges Perec, Species of Spaces and Other Pieces, Penguin, p63
                <br> <span class="number-spacing">4</span> Mae, Places for Strangers, Park Books, p28
                <br> <span class="number-spacing">5</span> Norman Potter, What is a Designer, Hyphen Press, p15
                <br> <span class="number-spacing">6</span> Sheila Levrant de Bretteville, A Reexamination of Some Aspects of the Design Arts from the Perspective of a Woman Designer, Arts in Society: Women and the Arts, Spring–Summer 1974, p115
                <br> <span class="number-spacing">7</span> Charles Jencks and Nathan Silver, Adhocism, MIT Press, pviii
                <br> <span class="number-spacing">8</span> Irénée Scalbert on Raphael Samuel, Never Modern, Park Books, p34
                <br> <span class="number-spacing">9</span> Susan Stewart, On Longing, Duke University Press, p23
