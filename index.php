    ...
    <div id="wrapper">
        ...
        <div id="text-container">
            ...
            <div id="chapter-6">
                ...
                <br>
                <br>A bone tatting shuttle in the Charnwood Museum told of C19th lacemakers supplementing their factory work with this choreographically complex hand technique. This interaction of hand and tool brings us to the Sports Technology Institute’s Steve Carr and his test run of a bonelike, low-melting-point, plastic tennis racket grip, designed for a para-athelete who had lost their ability to grip the racket. Steve is head of technical services and runs the test lab which holds a cross-section of kit from ball kicking robots and motion capture rigs to lathes, drills and welders. This oscillation from hardware-to-software-to-hardware mirrors Steve’s agility in tackling each research project whether it be the aerodynamic testing of adidas’ next World Cup football, or the design and fabrication of a bespoke archery frame for Paralympian Danielle Brown. Whilst explaining the structural composition of dismembered match balls, Steve referred to the two interlocking panel types as ‘turbines and rotors’ recalling our visit to Brush and their turbogenerator manufacturing.
                <br>
            ...
            <div class="endnote-text">
                1 Wally Olins, On Brand, Thames and Hudson, p 204
